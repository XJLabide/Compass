...
export const UPPER_LOWER_SESSIONS: ProgramSession[] = [
  {
    ...
    name: "Upper A",
    exercises: plan([
      { exerciseId: "bench-press", targetSets: 4, repRangeLow: 6, repRangeHigh: 10 },
  ...
  },
  {
    ...
    exercises: plan([
      ...
      { exerciseId: "lying-leg-curl", targetSets: 3, repRangeLow: 8, repRangeHigh: 12 },
      { exerciseId: "standing-calf-raise", targetSets: 4, repRangeLow: 8, repRangeHigh: 12 },
  ...
  },
  {
    ...
    exercises: plan([
      ...
      { exerciseId: "lateral-raise", targetSets: 3, repRangeLow: 10, repRangeHigh: 15 },
      { exerciseId: "hammer-curl", targetSets: 3, repRangeLow: 8, repRangeHigh: 12 },
      { exerciseId: "overhead-tricep-extension", targetSets: 3, repRangeLow: 8, repRangeHigh: 12 },
    ]),
  },
  {
    id: "lower-b",
